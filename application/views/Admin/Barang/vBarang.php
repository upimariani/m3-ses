<div class="main-content">
	<div class="container-fluid">
		...
		<a href="<?= base_url('Admin/cBarang/create') ?>" class="btn btn-success mb-3"><i class="ik ik-tag"></i>Tambah Data Bahan Baku</a>
		<?php
									...
									<tr>
										...
										<td class="text-center">
											<div class="table-actions">
												<a href="<?= base_url('Admin/cBarang/update/' . $value->id_bb) ?>"><i class="ik ik-edit-2"></i></a>
												<a href="<?= base_url('Admin/cBarang/delete/' . $value->id_bb) ?>"><i class="ik ik-trash-2"></i></a>
											</div>
										</td>
									</tr>
								<?php } ?>
