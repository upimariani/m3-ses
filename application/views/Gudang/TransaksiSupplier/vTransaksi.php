				...
				<div class="card card-info card-tabs">
					<div class="card-header p-0 pt-1">
						<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
							<?php
							$konfirmasi = $this->db->query("SELECT COUNT(id_transaksi) as notif FROM `transaksi` WHERE status='1'")->row();
							$diproses = $this->db->query("SELECT COUNT(id_transaksi) as notif FROM `transaksi` WHERE status='2'")->row();
							$dikirim = $this->db->query("SELECT COUNT(id_transaksi) as notif FROM `transaksi` WHERE status='3'")->row();
							$belum_bayar = $this->db->query("SELECT COUNT(id_transaksi) as notif FROM `transaksi` WHERE status='0'")->row();
							?>
							<li class="nav-item">
											...
											<tbody>
												...
												?>
														<tr>
															...
															<td class="text-center"> <a href="<?= base_url('Gudang/cTransaksi/detail_transaksi/' . $value->id_transaksi) ?>" class="btn btn-warning">
