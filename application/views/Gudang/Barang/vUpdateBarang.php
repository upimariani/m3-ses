			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-header">
						<h3>Perbaharui Data Bahan Baku</h3>

					</div>
					<div class="card-body">
						<?php echo form_open_multipart('Gudang/cBarang/update/' . $bb->id_bb); ?>
						<div class="form-group">
							...
							<select class="form-control" name="supplier">
								...
								?>
										<option value="<?= $value->id_user ?>" <?php if ($value->id_user == $bb->id_user) {
																					echo 'selected';
																				} ?>><?= $value->nama ?></option>
								<?php
									}
						...
						<div class="form-group">
							...
							<input type="text" name="nama" value="<?= $bb->nama_bb ?>" class="form-control" id="input-2" placeholder="Masukkan Nama Barang">
							<?= form_error('nama', '<small class="form-text text-danger">', '</small>'); ?>
						</div>
						<div class="form-group">
							<label for="input-3">Keterangan</label>
							<input type="text" name="keterangan" value="<?= $bb->keterangan ?>" class="form-control" id="input-3" placeholder="Masukkan Keterangan">
							<?= form_error('keterangan', '<small class="form-text text-danger">', '</small>'); ?>
						</div>

						<div class="form-group">
							<label for="input-4">Harga</label>
							<input type="number" name="harga" value="<?= $bb->harga ?>" class="form-control" id="input-4" placeholder="Masukkan Harga">
